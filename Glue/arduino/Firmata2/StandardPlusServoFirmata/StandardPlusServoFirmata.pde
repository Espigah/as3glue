/* 
  StandardFirmata for protocol v2 augmented with servo support:
  pins 9 and 10 are hardwired to always support servos and cannot be used for other I/O
  
  Copyright (C) 2006-2008 Hans-Christoph Steiner.  All rights reserved.
  Servo support added by Bjoern Hartmann.
